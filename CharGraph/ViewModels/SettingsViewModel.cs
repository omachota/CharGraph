...
namespace CharGraph.ViewModels
{
    public class SettingsViewModel : BaseViewModel
    {
        ...
        public SettingsViewModel(INavigator navigator, ArduinoDetector arduinoDetector)
        {
            ...
            Fuse1Changed = new Command(() => Write($"Fuse1 {Fuse1.Substring(0, Fuse1.Length - 2)}"));
            Fuse2Changed = new Command(() => Write($"Fuse2 {Fuse2.Substring(0, Fuse2.Length - 2)}"));
        }
        ...
        {
            get => _fuse1;
            set => SetAndRaise(ref _fuse1, value);
        }
        public string Fuse2
        {
            get => _fuse2;
            set => SetAndRaise(ref _fuse2, value);
        }
